...
class Theme
{
    ...
    {
        define("NEW_TEMPLATE_PLUGIN_INSTALLER", false);
    ...
    public function admin()
    {
        if (is_admin())
        {
            ...
            require_once THEME_CONTROL_PANEL . "/logic/logic-helpers.php";
    ...
    public function admin_menus()
    {
        ...
        if(NEW_TEMPLATE_PLUGIN_INSTALLER == true)
        {
    ...
    {
        if(NEW_TEMPLATE_PLUGIN_INSTALLER == false)
        {
