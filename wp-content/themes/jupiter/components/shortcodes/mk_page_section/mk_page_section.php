...
$classes[] = ( $adaptive_height !== 'false' ) ? 'mk-adaptive-height' : '';
...
if ( ! empty( $adaptive_height ) && $adaptive_height === 'true' ) {
    
    $overflow_property   = ( empty( $overflow ) || $overflow === 'true' ) ? 'overflow: hidden' : '';
    $bg_stretch_property = ( empty( $bg_stretch ) || $overflow === 'true' ) ? 'background-size: contain' : '';
