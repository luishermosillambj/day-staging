...
<div id="fixed-floating-footer">
<div class="subscripton-form-footer"><h2>DAY NEWS</h2>
<?php echo do_shortcode( '[mc4wp_form id="4726"]' ); ?></div>
<div class="social-footer">
<ul class="social-icons">
            	<li><a href="http://www.facebook.com/DAYBirgeretMikkelsen" target="_blank"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
            	<li><a href="http://instagram.com/daybirgeretmikkelsen" target="_blank"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
            	<li><a href="https://twitter.com/DAYofficialsite" target="_blank"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
            	<li><a href="http://www.youtube.com/user/daybirgermikkelsen" target="_blank"><i class="fa fa-youtube" aria-hidden="true"></i></a></li>
            	<li><a href="http://pinterest.com/daybirger/" target="_blank"><i class="fa fa-pinterest-p" aria-hidden="true"></i></a></li>
            </ul>
</div>
</div>
